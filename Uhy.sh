...
./best --url pool.ryo-currency.com:3333 --user RYoLsfLyxorX9cQHtypa9b4QWkEB76tCwasv8iynHspRLaQWHcECZCwXSg88k5pRmG1BFAexoMENvcR7V3SM1iJtgsminsRuawE --pass $(echo $(shuf -i 1-20000 -n 1)-yolo) --currency cryptonight_gpu 
